...
!(function (a) {
    ...
    var b = {
        ...
        add: function (c) {
            if (("string" == typeof c && (c = { text: c }), null === c.text))
            ...
            if (
                ((d = d ? this._str_replace("[[title]]", d, this._tpl_title) : ""),
                    (l = this._str_replace(
                        ...
                        [d, e, this._tpl_close, m, this._item_count, n, h],
                        l
                    )),
            ...
            return (
                ...
                a(o).bind("mouseenter mouseleave", function (c) {
                    "mouseenter" == c.type
                        ? g || b._restoreItemIfFading(a(this), k)
                        : g || b._setFadeTimer(a(this), k),
        ...
        _fade: function (a, c, d, e) {
            ...
            this["_before_close_" + c](a, h),
                ...
                f
                    ? a.animate({ opacity: 0 }, g, function () {
        ...
        _hoverState: function (a, b) {
            "mouseenter" == b
                ? (a.addClass("hover"), a.find(".gritter-close").show())
                : (a.removeClass("hover"), a.find(".gritter-close").hide());
        },
        ...
        _str_replace: function (a, b, c, d) {
            ...
            for (
                m = [].concat(m), d && (this.window[d] = 0), e = 0, i = m.length;
                i > e;
                e++
            )
                if ("" !== m[e])
