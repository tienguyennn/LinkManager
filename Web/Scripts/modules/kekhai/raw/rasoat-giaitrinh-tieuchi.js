var $formRaSoatSoLieuKeKhai = $('#form-rasoat-solieu-giaitrinh');
...
var $idTieuChiDuocRaSoat = document.getElementById('IdTieuChi').value;
...
function onLuuSoLieuRaSoatGiaiTrinh() {
 ...
 * */
function onLuuSoLieuRaSoatGiaiTrinhMultiple() {
    saveTempThongTinRaSoatGiaiTrinh();

    var dataRaSoatLocalStorage = localStorage.getItem('tempThongTinRaSoatGiaiTrinhTieuChi');
    ...
    onCallAjax('/KeKhaiArea/RaSoatGiaiTrinh/LuuRaSoatSoLieuGiaiTrinhNhieuTieuChi',
        {
            idHoSoKeKhai: $idHoSo,
            ...
            if (dataRaSoatLocalStorage) {
                localStorage.removeItem('tempThongTinRaSoatGiaiTrinhTieuChi');
            }
...
function onLuuRaSoatSoLieuKeKhaiSuccess(result) {
    ...
    if (isRaSoatSuccess) {
        ...
        //onCallAjax('/KeKhaiArea/RaSoatGiaiTrinh/GetLichSuKeKhaiRaSoatThamDinh',
        ...
        highLightTieuChiRaSoatGiaiTrinh();
 ...
 * @param {any} isNext
 */
function onChuyenTieuChiGiaiTrinh(numbThuTuTieuChi, isNext) {
    saveTempThongTinRaSoatGiaiTrinh();
    ...
    if (elementTieuChi) {
        ...
        if (configKey) {
            onCallAjax('/KeKhaiArea/RaSoatGiaiTrinh/RaSoatSoLieuGiaiTrinhTieuChi',
                {
                    idHoSo: $idHoSo,
                    idTruCotSo: $idTruCotSo,
                    ...
                    $('#form-rasoat-solieu-giaitrinh').closest('.modal').html(result);
                });
        }
    }
}

function onChangeTieuChiRaSoatGiaiTrinh(element) {
    saveTempThongTinRaSoatGiaiTrinh();
...
/**
 *lưu các thông tin rà soát vào tiêu chí
 **/

function saveTempThongTinRaSoatGiaiTrinh() {
    var arrInfoRaSoatTieuChi = [];
    var localStorageRaSoatTieuChi = localStorage.getItem('tempThongTinRaSoatGiaiTrinhTieuChi');
    ...
    localStorage.setItem('tempThongTinRaSoatGiaiTrinhTieuChi', JSON.stringify(arrInfoRaSoatTieuChi));
}

/**
 * hiển thị dữ liệu của lần trước
 */
function getTempThongTinRaSoatGiaiTrinh() {
    var arrInfoRaSoatTieuChi = [];
    var localStorageRaSoatTieuChi = localStorage.getItem('tempThongTinRaSoatGiaiTrinhTieuChi');
    if (!localStorageRaSoatTieuChi) {
        return false;
 ...
 */
function highLightTieuChiRaSoatGiaiTrinh() {

    onCallAjax('/KeKhaiArea/RaSoatGiaiTrinh/GetListTieuChiDaChot',
                ...
                arrTieuChiRaSoat.forEach(function (item) {
                    ...
                    if (item.IsTieuChiTinhDiem == true) {
                        ...
                        if (elementDiemRaSoat && elementDiemRaSoat.length > 0) {
                            elementDiemRaSoat.html("Điểm chốt: <b>" + item.SoLieuRaSoat + "</b>");
                        } else {
                            elementDiemKeKhai.after('<br/><span class="text-info lbl-solieu-rasoat" id="diem-rasoat-' + domID + '">Điểm chốt: <b>' + item.SoLieuRaSoat + '</b></span>');
                        }
                    ...
                    if (item.IsTieuChiDuocRaSoat == true) {
                        ...
                        if (elementRaSoat && elementRaSoat.length > 0) {
                            elementRaSoat.html(!isSoLieuRaSoatEmpty ? 'Số liệu chốt: <b>' + textSoLieuRaSoat + '</b></span>' : "");
                        } else {
                            elementKeKhai.after('<br/><span class="text-info lbl-solieu-rasoat tieuchi-has-rasoat" id="' + idElementRaSoat + '">' + (!isSoLieuRaSoatEmpty ? 'Số liệu chốt: <b>' + textSoLieuRaSoat + '</b>' : '') + '</span>');
                        }
                        ...
                        if (!item.IsTieuChiDisabledKeKhai) { //không hiển thị ý kiến với các tiêu chí bị disabled
                            ...
                            if (elementYKien && elementYKien.length > 0) {
                                elementYKien.html("Ý kiến chốt: <b>" + item.TextYKienDanhGia + "</b>");
                            } else {
                                elementRaSoat.after('<br/><span class="lbl-ykien-rasoat" id="' + idElementYKien + '">Ý kiến chốt: <b>' + item.TextYKienDanhGia + '</b></span>');
                            }
                        }
                        ...
                        if (isThayDoiSoLieuSauRaSoat) {
                            ...
                            elementKeKhai.removeClass('has-changed-after-rasoat');
                        }
...
$(document).ready(function () {
    getTempThongTinRaSoatGiaiTrinh();
})