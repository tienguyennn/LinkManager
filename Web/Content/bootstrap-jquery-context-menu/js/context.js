...
context = (function () {
    ...
    function initialize(opts) {
        ...
        $(document).on('click', function (e) {
            if (!e.target.classList.value.includes("fa-ellipsis-v")) {
            ...
            if (typeof data[i].divider !== 'undefined') {
                ...
                if (typeof data[i].subMenu !== 'undefined') {
                    ...
                    if (typeof data[i].icon !== 'undefined')
                        element += '<i class="context-menu-icon ' + data[i].icon + '"></i> ';
                ...
                if ((typeof data[i].disabled === 'boolean' && data[i].disabled === true)
                    || (typeof data[i].disabled === 'function' && data[i].disabled() === true)) {
                    $sub.find('a')
                        .addClass('disabled');
                }
                $menu.append($sub);
    ...
    function addContext(selector, data) {
        ...
        $(selector).on('contextmenu', function (e) {
            ...
            if (!NExploer.selected.includes(itemId)) {
                NExploer.selected.clear();
                NExploer.selected.push(id);
                NExploer.selected.clear();
                $('.file-item.selected,.directory-item.selected').removeClass("selected");
                $('#item-' +itemId).addClass("selected");
            }
            e.preventDefault();
            e.stopPropagation();
