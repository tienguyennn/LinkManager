...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        $.getScript("/Content/LibUploadFile/jquery.form.js", function (data, textStatus, jqxhr) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend(
            {
                ...
                dragDropStr: "<span><b>Kéo &amp; thả file</b></span>",
                uploadStr: "Tải lên",
                abortStr: "Huỷ bỏ",
                cancelStr: "Huỷ bỏ",
                deleteStr: "Xoá",
                doneStr: "Xong",
                multiDragErrorStr:
                    "Không được tải lên. Số file tối đa được tải lên là: 1",
                extErrorStr: "không được hỗ trợ. Chỉ được tải lên các định dạng: ",
                duplicateErrorStr:
                    "is not allowed. File already exists.",
                sizeErrorStr: "is not allowed. Allowed Max size: ",
                uploadErrorStr: "Tập tin không được hỗ trợ",
                maxFileCountErrorStr:
                    " không được tải lên. Số file tối đa được tải lên là: ",
                downloadStr: "Download",
                viewfileStr: "ViewFile",
        ...
        this.fileCounter = 1;
        this.selectedFiles = s.selectedFiles;
                ...
                if (
                    ...
                    if (s.showError)
                        $(
                            ...
                            `${s.maxFileCount == 0 ? 1 : s.maxFileCount}` +
                            "</div>"
                        ).appendTo(obj.errorLog);
                    continue;
                }
        ...
        function removeExistingFileName(obj, fileArr) {
            if (obj.existingFileNames.length) {
                for (var x = 0; x < fileArr.length; x++) {
                    var pos = obj.existingFileNames.indexOf(
                        fileArr[x]
                    );
                    if (pos != -1) {
            ...
            if (s.showFileCounter) {
                ...
                $(obj.container)
                    ...
                    .each(function (i, items) {
                        ...
                        var name =
                            count + s.fileCounterStyle + arr[1];
                        $(this).html(name);
                        count--;
                    });
            }
        ...
        function defaultProgressBar(obj, s) {
            ...
            this.del = $("<div>" + s.deleteStr + "</div>")
                .appendTo(this.statusbar)
                .hide();
            this.viewfile = $("<div>" + s.viewfileStr + "</div>")
                .appendTo(this.statusbar)
                .hide();
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj, file) {
                ...
                success: function (data, message, xhr) {
                                    ...
                                    buttons: {
                                        "Đồng ý": {
                                            ...
                                            action: function () {
                                                ...
                                                obj.selectedFiles -=
                                                    fileArray.length; //reduce selected File count
                                                updateFileCounter(
                                                    s,
                                                    obj
                                                );
                    ...
                    if (s.showViewFile) {
                        ...
                        pd.viewfile.click(function () {
                            if (s.viewfileCallback)
                                s.viewfileCallback(data, pd);
                        });
                    }
                    form.remove();
                },
            ...
            if (s.showPreview && file != null) {
                if (
                    file.type.toLowerCase().split("/").shift() ==
                    "image"
                )
