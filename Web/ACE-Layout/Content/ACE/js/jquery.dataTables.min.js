...
!function (a, b, c) {
    !function (a) {
        ...
        function g(a) {
            ...
            !a.sEmptyTable && c && "Không có dữ liệu" === b.sEmptyTable && Lb(a, a, "sZeroRecords", "sEmptyTable"), !a.sLoadingRecords && c && "Loading..." === b.sLoadingRecords && Lb(a, a, "sZeroRecords", "sLoadingRecords"), a.sInfoThousands && (a.sThousands = a.sInfoThousands);
            var d = a.sDecimal;
            d && Ub(d)
        }
        ...
        function y(a, b, d, e) {
            var f = a.iDraw, g = a.aoColumns[d], h = a.aoData[b]._aData, i = g.sDefaultContent,
        ...
        function K(a) {
            var b, c, e, f, g, h = a.nTHead, i = a.nTFoot, j = 0 === d("th, td", h).length, k = a.oClasses,
                l = a.aoColumns;
        ...
        function M(a) {
            ...
            var e = [], f = 0, g = a.asStripeClasses, h = g.length, i = (a.aoOpenRows.length, a.oLanguage),
                j = a.iInitDisplayStart, k = "ssp" == Sb(a), l = a.aiDisplay;
        ...
        function O(a) {
            ...
            for (var h, i, j, k, l, m, n = a.sDom.split(""), o = 0; o < n.length; o++) {
                if (h = null, i = n[o], "<" == i) {
                    ...
                    g.append(j), g = d(j)
                } else if (">" == i) g = g.parent(); else if ("l" == i && f.bPaginate && f.bLengthChange) h = kb(a); else if ("f" == i && f.bFilter) h = W(a); else if ("r" == i && f.bProcessing) h = nb(a); else if ("t" == i) h = pb(a); else if ("i" == i && f.bInfo) h = eb(a); else if ("p" == i && f.bPaginate) h = lb(a); else if (0 !== Wb.ext.feature.length)for (var q = Wb.ext.feature,
                                                                                                                                                                                                                                                                                                                                                                                r = 0,
        ...
        function T(a) {
            var b, c, e, f, g = a.aoColumns, h = g.length, i = a.oFeatures, j = a.oPreviousSearch,
                k = a.aoPreSearchCols, l = [], m = Ab(a), n = a._iDisplayStart,
                o = i.bPaginate !== !1 ? a._iDisplayLength : -1, p = function (a, b) {
        ...
        function U(a, b) {
            var d = function (a, d) {
                ...
                }, e = d("sEcho", "draw"), f = d("iTotalRecords", "recordsTotal"),
        ...
        function W(a) {
            var c = a.oClasses, e = a.sTableId, f = a.oLanguage, g = a.oPreviousSearch, h = a.aanFeatures,
                i = '<input type="search" class="' + c.sFilterInput + '"/>', j = f.sSearch;
        ...
        function Y(a) {
            for (var b, c, d = Wb.ext.search, e = a.aiDisplay, f = 0, g = d.length; g > f; f++) {
                for (var h = [], i = 0,
                         j = e.length; j > i; i++)c = e[i], b = a.aoData[c], d[f](a, b._aFilterData, c, b._aData, i) && h.push(c);
        ...
        function fb(a) {
            ...
            if (0 !== b.length) {
                var c = a.oLanguage, e = a._iDisplayStart + 1, f = a.fnDisplayEnd(), g = a.fnRecordsTotal(),
        ...
        function kb(a) {
            for (var b = a.oClasses, c = a.sTableId, e = a.aLengthMenu, f = d.isArray(e[0]), g = f ? e[0] : e,
                     h = f ? e[1] : e,
                     i = d("<select/>", {name: c + "_length", "aria-controls": c, "class": b.sLengthSelect}), j = 0,
        ...
        function lb(a) {
            ...
            return e || c.fnInit(a, g, f), h.p || (g.id = a.sTableId + "_paginate", a.aoDrawCallback.push({
                fn: function (a) {
                    if (e) {
                        var b, d, g = a._iDisplayStart, i = a._iDisplayLength, j = a.fnRecordsDisplay(), k = -1 === i,
                            l = k ? 0 : Math.ceil(g / i), m = k ? 1 : Math.ceil(j / i), n = c(l, m);
        ...
        function pb(a) {
            ...
            var e = c.sX, f = c.sY, g = a.oClasses, h = b.children("caption"), i = h.length ? h[0]._captionSide : null,
                j = d(b[0].cloneNode(!1)), k = d(b[0].cloneNode(!1)), l = b.children("tfoot"), m = "<div/>",
                n = function (a) {
                    return a ? yb(a) : null
                };
        ...
        function qb(a) {
            var b, c, e, f, g, h, i, j, k, l = a.oScroll, m = l.sX, n = l.sXInner, p = l.sY, q = l.iBarWidth,
                r = d(a.nScrollHead), s = r[0].style, t = r.children("div"), u = t[0].style, v = t.children("table"),
                w = a.nScrollBody, x = d(w), y = w.style, z = d(a.nScrollFoot), A = z.children("div"),
                B = A.children("table"), C = d(a.nTHead), D = d(a.nTable), E = D[0], F = E.style,
                G = a.nTFoot ? d(a.nTFoot) : null, H = a.oBrowser, I = H.bScrollOversize, J = [], K = [], L = [],
                M = function (a) {
                    var b = a.style;
        ...
        function sb(b) {
            var c, e, f, g, h, i = b.nTable, j = b.aoColumns, k = b.oScroll, l = k.sY, m = k.sX, o = k.sXInner,
                p = j.length, s = r(b, "bVisible"), t = d("th", b.nTHead), u = i.getAttribute("width"),
                v = i.parentNode, w = !1;
        ...
        function xb(a, b) {
            for (var c, d = -1, e = -1, f = 0,
                     g = a.aoData.length; g > f; f++)c = y(a, f, b, "display") + "", c = c.replace(xc, ""), c.length > d && (d = c.length, e = f);
            return e
        }
        ...
        function Ab(a) {
            var b, e, f, g, h, i, j, k = [], l = a.aoColumns, m = a.aaSortingFixed, n = d.isPlainObject(m), o = [],
                p = function (a) {
        ...
        function Gb(a, b) {
            ...
            for (var f, g, h = Wb.ext.type.order[d.sType + "-pre"], i = 0,
        ...
        Wb = function (a) {
            ...
            return this.each(function () {
                var n, o = {}, p = k > 1 ? Mb(o, a, !0) : a, q = 0, r = this.getAttribute("id"), s = !1,
                    w = Wb.defaults;
        ...
        Yb = function (a, b) {
            ...
            filter: function (a) {
                var b = [];
                if (zc.filter) b = zc.filter.call(this, a, this); else for (var c = 0,
            ...
            map: function (a) {
                var b = [];
                if (zc.map) b = zc.map.call(this, a, this); else for (var c = 0,
        ...
        Zb("tables()", function (a) {
            ...
            var a = this.context[0], b = a._iDisplayStart, d = a._iDisplayLength, e = a.fnRecordsDisplay(),
                f = -1 === d;
            return {
        ...
        var Dc = function (a, b) {
            ...
            for (var b = 0,
                     c = a.length; c > b; b++)if (a[b].length > 0)return a[0] = a[b], a.length = 1, a.context = [a.context[b]], a;
            return a.length = 0, a
        }, Gc = function (a, b) {
        ...
        var Ic = function (a, b, c, e) {
            ...
            var b = new Yb(a), c = ".dt.DT_details", d = "draw" + c, e = "column-visibility" + c, f = "destroy" + c,
                g = a.aoData;
            b.off(d + " " + e + " " + f), mc(g, "_details").length > 0 && (b.on(d, function (c, d) {
                ...
                if (a === c)for (var d, e = q(c), f = 0,
                                     h = g.length; h > f; f++)d = g[f], d._details && d._details.children("td[colspan]").attr("colspan", e)
            }), b.on(f, function (c, d) {
        ...
        var Tc = function (a, b, e) {
            var f, g, h, i, j, k, l, m = a.aoData, n = Gc(a, e), o = pc(nc(m, n, "anCells")),
                p = d([].concat.apply([], o)), q = a.aoColumns.length;
            return Dc(b, function (b) {
        ...
        Zb("cells()", function (a, b, e) {
            ...
            for (var b, c, d = Wb.version.split("."), e = a.split("."), f = 0,
            ...
            return b = b || !1, this.iterator("table", function (c) {
                var e, f = c.nTableWrapper.parentNode, g = c.oClasses, h = c.nTable, i = c.nTBody, j = c.nTHead,
                    k = c.nTFoot, l = d(h), m = d(i), n = d(c.nTableWrapper), o = d.map(c.aoData, function (a) {
                        return a.nTr
                    });
            ...
            var a = "";
            a = "";
            var b = a + "ui-state-default", c = a + "css_right ui-icon ui-icon-",
