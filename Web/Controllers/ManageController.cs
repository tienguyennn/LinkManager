...
namespace Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            {
                var idUser = User.Identity.GetUserId<long>();
                var appUser = _AppUserService.GetById(idUser);
                appUser.IsUpdateNewPass = true;
            ...
            {
                result.Status = false;
                result.Message = changePasswordResult.Errors.Contains("Incorrect password.") ? "Mật khẩu cũ không chính xác" : "Đổi mật khẩu thất bại";
            }
            return Json(result);
        }
